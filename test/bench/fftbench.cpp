...
#else
static const int TEST_SIZE   =  4*2097152;
#endif
...
class polynomial
{
    public:
        ...
        void dump(ostream& os, size_t limit) {
          // NOTE: not sure if it's a polynomial of one variable.
          // Just want some output for regression tests.
          limit = min(degree(), limit);
