// RUN: %clang -DSMALL_PROBLEM_SIZE -O3 -fhalo %s -o %t
...
/*     compute a residual to verify results.  */
        ...
        fprintf(stdout,"norm resid      resid           machep");
        fprintf(stdout,"         x[0]-1          x[n-1]-1\n");
        fprintf(stdout,"%6.1f %17.8e%17.8e%17.8e%17.8e\n\n",
